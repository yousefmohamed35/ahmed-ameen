...
import '../../screens/auth/student_academic_selection_screen.dart';
import '../../screens/student/home_screen.dart';
import '../../screens/student/courses_screen.dart';
import '../../screens/student/progress_screen.dart';
import '../../screens/student/student_dashboard_screen.dart';
import '../../screens/student/term_payment_plans_screen.dart';
import '../../screens/student/term_payment_status_screen.dart';
...
class AppRouter {
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: RouteNames.rejectedAccount,
        pageBuilder: (context, state) {
          final reason = state.extra is String ? state.extra as String : null;
          return _buildPageWithTransition(
            key: state.pageKey,
            child: RejectedAccountScreen(reason: reason),
          );
        },
      ),
      GoRoute(
        path: RouteNames.studentAcademicSelection,
        pageBuilder: (context, state) => _buildPageWithTransition(
          key: state.pageKey,
          child: const StudentAcademicSelectionScreen(),
        ),
      ),
      ...
      GoRoute(
        path: RouteNames.termPaymentPlans,
        pageBuilder: (context, state) => _buildPageWithTransition(
          key: state.pageKey,
          child: const TermPaymentPlansScreen(),
        ),
      ),
      GoRoute(
        path: RouteNames.termPaymentStatus,
        pageBuilder: (context, state) => _buildPageWithTransition(
          key: state.pageKey,
          child: const TermPaymentStatusScreen(),
        ),
      ),
      GoRoute(
