...
class AppColors {
  ...
  static const Color background = Color(0xFFFCF9E6); // --beige
  ...
  // Primary colors
  static const Color primary = Color(0xFF5A4544); // --purple
  static const Color primaryForeground =
      Color(0xFFFFFFFF); // --primary-foreground
  static const Color primaryDark = Color(0xFF5A4544); // --purple-dark
  static const Color primaryLight = Color(0xFF5A4544); // --purple-light

  // Secondary colors
  static const Color secondary = Color(0xFF040825); // --orange
  static const Color secondaryForeground =
      Color(0xFF1A1A2E); // --secondary-foreground
  static const Color secondaryLight = Color(0xFF040825); // --orange-light
  ...
  static const Color ring = Color(0xFF5A4544); // --ring

  // Custom app colors
  static const Color beige = Color(0xFFFCF9E6); // --beige
  static const Color beigeDark = Color(0xFFE8DDD4); // --beige-dark
  static const Color orange = Color(0xFF040825); // --orange
  static const Color orangeLight = Color(0xFF040825); // --orange-light
  static const Color purple = Color(0xFF5A4544); // --purple
  static const Color purpleLight = Color(0xFF5A4544); // --purple-light
  static const Color purpleDark = Color(0xFF5A4544); // --purple-dark
