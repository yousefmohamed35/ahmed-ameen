...
class ApiEndpoints {
  ...
  static const String baseUrl = 'https://ahmedamin.anmka.com/api';

  /// Base URL for images and media files 
  static const String imageBaseUrl = 'https://ahmedamin.anmka.com';
  ...
  static String get subcategories => '$baseUrl/subcategories';
  ...
  // Bundle purchases (student)
  static String get bundlePurchases => '$baseUrl/bundle-purchases';
  static String bundlePurchasePayments(String purchaseId) =>
      '$baseUrl/bundle-purchases/$purchaseId/payments';
  static String get myBundlePurchases => '$baseUrl/bundle-purchases/my';

  /// Socket.IO base URL – https://ahmedamin.anmka.com, no port (default 443).
