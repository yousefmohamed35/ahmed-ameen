...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: const LinearGradient(
          ...
          colors: [Color(0xFF5A4544), Color(0xFF5A4544), Color(0xFF040825)],
        ),
        ...
        child: Container(
          decoration: BoxDecoration(
            gradient: const LinearGradient(
              ...
              colors: [
                Color(0xFF5A4544), Color(0xFF5A4544), Color(0xFF040825),
                Color(0xFF4C1D95),
              ],
            ),
            ...
            boxShadow: [
              BoxShadow(
                color: const Color(0xFF5A4544).withOpacity(0.4),
                blurRadius: 25,
  ...
  Color _parseColor(dynamic colorValue) {
    ...
    if (colorValue is String) {
      // Handle hex color strings like "#5A4544" or "7C3AED"
