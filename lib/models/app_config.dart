...
class ThemeConfig {
  ...
  factory ThemeConfig.fromJson(Map<String, dynamic> json) {
    return ThemeConfig(
      primaryColor: json['primary_color'] as String? ?? '#5A4544',
      secondaryColor: json['secondary_color'] as String? ?? '#040825',
      ...
      backgroundColor: json['background_color'] as String? ?? '#FCF9E6',
